...
public class Test01 {
	...
	public Test01() {
		...
		try {
			...
			String sql04 = "SELECT mno, name, id, pw, mail, gen , tel HP, ano avatarno, isShow status FROM member WHERE mno = 1000";
			/*
			...
			*/
			...
			// 현재 작업줄은 BOF 이므로 실제 데이터가 들어있는 행으로 한행 내려야 된다.
			rs.next();			
			/*
			int mno = rs.getInt(1);
			...
			*/
			...
			JOptionPane.showMessageDialog(null, "잘생긴 "+name + "선생님 정보\n회원번호 : "+mno+
					"\n회원아이디 : "+ mid + "\n회원비번 : " + mpw + "\n회원메일 : " +mail +
					"\n회원성별 : "+ gen + "\n회원전화 : " + tel + "\n아바타번호 : " + ano +
