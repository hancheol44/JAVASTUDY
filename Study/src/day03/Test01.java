  		  	 ...
  		  	 1. 조건제어명령
  		  	 	...
  		  	 	형식 3]
  		  	 		...
  		  	 		if(조건식1 - (2)) {
  		  	 		 ...
  		  	 		 조건식1이 참일경우 	1 → 2 → 3 → 9
  		  	 		 조건식2가 참일경우 	1 → 2 → 4 → 5 → 9
  		  	 		 조건식n이 참일경우 	1 → 2 → .... → n → 6 → 9
  		  	 		 모든조건이 거짓일경우  1 → 2 → .... → n → 8 → 9
...
// 예제 ] 숫자 두개를 입력받아서 큰 수에서 작은 수를 뺀 차를 출력하세요.	
	...
	public void solv() {
		...
		// 크기비교하고
		// 블럭안에 만들어진 변수는 블럭밖으로 빠져오면 사라지는 변수이므로
		...
		// 출력하고
//		System.out.println("입력한 두개의 수 : "+ no1 + "&" + no2 +"의 차는"+cha+"입니다.");
		System.out.println("입력한 두개의 수 : "+ max + " & " + min +"의 차는"+cha+"입니다.");
		
		/*
	 	 심화문제]
	 	 	큰수와 작은수를 구분하는 변수 두개를 만들지 말고
	 	 	추가적으로 변수를 하나만 만들어서 (int tmp)
	 	 	큰수와 작은수를 구분하세요.
		 */
		if(no2 > no1) {
			int tmp = no1;
