...
public class Test06 {
/*
 		랜덤하게 정수 11 ~ 33까지의 두 수를 랜덤하게 발생시키고
 		숫자를 입력 받아서
 ...
 */
	public Test06() {
		...
		// 코드값이 1 이면 삼각형 넓이를 구해서 출력해주고, 2 이면 사각형 넓이를 구해서 출력해주자.
		/*
		  	사각형과 삼각형의 넓이의 타입이 다르기 때문에 
		  	한가지 타입으로 통일 시켜주어야한다.
		  	여기서는 함수 실행의 결과를 그대로 출력할 용도로만 사용할 것이기 때문에
		  	문자열로 통일해서 사용하면 될 것 같
		 */
		/* 방법 1]
