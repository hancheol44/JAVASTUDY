...
public class Jjokji {
	...
	public void toTest() {
		System.out.println("손은진 IP : " + nameToIp.get("손은진"));
		System.out.println("박광호 IP : " + nameToIp.get("박광호"));
	}
	...
	public void setMap() {
		...
		try {
			fin1 = new FileInputStream("Study/src/net_test/ip_ko.properties");
			fin2 = new FileInputStream("Study/src/net_test/name_ko.properties");
